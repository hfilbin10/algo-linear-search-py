...
def test_global_search_multiple_numbers():
    assert linear_search_global(3, [2, 8, 1, 3, 5, 8, 12, 23, 3, 24, 100, 3]) == [3, 8, 11,]
...
def test_global_search_number_does_not_exist():
    assert linear_search_global(4, [2, 8, 1, 3, 5, 8, 12, 23, 3, 24, 100, 3]) == None
...
def test_global_search_does_not_exist_tuple():
    assert (
        linear_search_global(2, (1, 3, 8, 12, 4, 16, 18, 12, 21, 53, 55, 12, 332)) == None
    )